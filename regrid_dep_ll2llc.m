...
%   02 Jul 2015 - H. Amos - Final units of regridded deposition should
%                           be mol/m2/s and concentrations should be
%                           mol/m3.
%   
%
% Helen M. Amos 
...
% convert deposition from units of kg to mol/m2/sec
gasdep_latlon  = 1e3/(MW*numsec) * gasdep_latlon ./ surfarea;
partdep_latlon = 1e3/(MW*numsec) * partdep_latlon ./ surfarea;
